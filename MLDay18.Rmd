...
* Partial dependence plots (PDPs) help visualize the relationship between a subset of the features (typically 1-3) and the response
...
* In contrast to bagging, boosting:
    ...
    - Uses a *weak learner* for base learners
...
$Error \approx Bias + Variance\left(\rho\right)$ 
